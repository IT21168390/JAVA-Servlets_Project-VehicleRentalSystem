...
<body>
	...
	<br><form action="UserDelete" method="post">
	<table>
		<tr><td><label id="upL">User ID: </label></td><td><input id="upF" type="text" name="id" value="<%=id%>" readonly></td></tr>
		<tr><td><label id="upL">Your Name: </label></td><td><input id="upF" type="text" name="name" value="<%=name%>" readonly></td></tr>
		<tr><td><label id="upL">Your Phone Number: </label></td><td><input id="upF" type="text" name="phone" value="<%=phone%>" readonly></td></tr>
		<tr><td><label id="upL">Your Email: </label></td><td><input id="upF" type="email" name="email" value="<%=email%>" readonly></td></tr>
		<tr><td><label id="upL">Username: </label></td><td><input id="upF" type="text" name="user" value="<%=username%>" readonly></td></tr>
		<tr><td><label id="upL">User Type: </label></td><td><input id="upF" type="text" name="type" value="<%=type%>" readonly></td></tr>
	</table><br>
		<b><input id="updateUser" type="submit" name="submit" value="Confirm Account Deletion"></b>
	</form>
	</div></center>
